...
class SizeController extends Controller
{
    ...
    public function store(StoreSizeRequest $request)
    {
        ...
        return redirect(route('dashboard.sizes.index'))->with('success' , 'تم إاضهف المقاس بنجاح' );
    }
    ...
    public function update(UpdateSizeRequest $request, Size $size)
    {
        ...
        return redirect(route('dashboard.sizes.index'))->with('success' , 'تم تعديل المقاس بنجاح' );
    }
