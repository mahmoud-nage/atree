<div>
    <div class="card">
        <div class="card-header bg-primary text-white header-elements-sm-inline" >
            <h5 class="card-title"> @lang('bank_accounts.show_all_bank_accounts') </h5>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th> @lang('bank_accounts.status') </th>
                        <th> @lang('bank_accounts.created_at') </th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='{{ route('dashboard.bank_accounts.show' , ['bank_account' => $bank_account->id ] ) }}' class="btn btn-primary btn-icon"><i class="icon-eye "></i></a>
                            <a href='{{ route('dashboard.bank_accounts.edit' , ['bank_account' => $bank_account->id ] ) }}' class="btn btn-warning btn-icon"><i class="icon-database-edit2 "></i></a>
                            <a class="btn btn-danger btn-icon delete_item"  data-item_id='{{ $bank_account->id }}' ><i class="icon-trash "></i></a>
                        </td>
...
<script>
    $(document).ready(function () {
        ...
        Livewire.on('itemDeleted', postId => {
            Toast.fire({
                icon: 'success',
                title: '@lang('bank_accounts.bank_account_deleted')'
            })
        })
