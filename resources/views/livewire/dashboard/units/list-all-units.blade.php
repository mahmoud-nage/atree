<div>
    <div class="card">
        <div class="card-header bg-primary text-white header-elements-sm-inline" >
            <h5 class="card-title"> @lang('units.show_all_units') </h5>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td> {{ $unit->id }} </td>
                        <td> <img class='rounded img-preview' src="{{ Storage::url('units/'.$unit->logo) }}" alt=""> </td>
                        <td> {{ $unit->getTranslation('name' , 'ar') }} </td>
                        <td> {{ $unit->getTranslation('name' , 'en') }} </td>
                        <td> {{ $unit->created_at->diffForHumans() }} </td>
                        <td>
                            <a href='{{ route('dashboard.units.show' , ['unit' => $unit->id ] ) }}' class="btn btn-primary btn-icon"><i class="icon-eye "></i></a>
                            <a href='{{ route('dashboard.units.edit' , ['unit' => $unit->id ] ) }}' class="btn btn-warning btn-icon"><i class="icon-database-edit2 "></i></a>
                            <a class="btn btn-danger btn-icon delete_item"  data-item_id='{{ $unit->id }}' ><i class="icon-trash "></i></a>
                        </td>
