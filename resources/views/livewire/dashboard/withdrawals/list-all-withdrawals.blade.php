    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2 ">
                    <div class="form-group">
                        <select wire:model='user' class="form-control form-control-select2">
                    ...
                    <tr>
                        <td>
                            <div class="custom-control custom-checkbox mb-2">
                                <input type="checkbox" value='{{ $withdrawal->id }}' class="custom-control-input"
                                       wire:model='selected' id="cc_ls_c{{ $withdrawal->id }}">
                        ...
                        <td>
                            <a class="btn btn-success btn-icon"
                               wire:click="$emit('quick-view' , {{ $withdrawal->id }})"><i
                                    class="icon-popout  "></i></a>
                            <a href='{{ route('dashboard.withdrawals.show' , ['withdrawal' => $withdrawal->id ] ) }}'
                               class="btn btn-primary btn-icon"><i class="icon-eye "></i></a>
                            {{--                            <a class="btn btn-danger btn-icon delete_item" data-item_id='{{ $withdrawal->id }}'><i--}}
                                    ...
                                    <div class="form-group">
                                        <div class="alert alert-warning alert-styled-left alert-dismissible">
                                            ...
                                            <ul>
                                                ...
                                                <li> الخانه الثانيه هيا حاله الطب ....(1) فى حاله قيد المراجعه , (3) عند
                                                    اتمام التحويل ... (2) عند جارى ارسال الارباح (4) عند اتمام الارسال
                                                    بنجاح
                                                </li>
                                                <li> الخانه الثالثه هيا طريقه الدفع حاليا يتم وضع 1 للمحفظه الاكتورنيه
                                                </li>
