<div class="card card-primary bio-content">
    <div class="card-header">
        ...
        <div class="ml-auto">
            ...
            <div class="row">
                <!--Add Adress Modal -->
                <div class="modal fade" id="addAddressPopup" wire:ignore.self tabindex="-1" role="dialog"
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" wire:submit.prevent="save">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-12">
                                            <select wire:model='product_id' class='form-control' id="product_id" multiple>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" wire:model='description' class="form-control"
                                                   id="description" placeholder="@lang('site.description')">
                                            @error('description')
                                            <p class='text-danger'> {{ $message }} </p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="image"
                                               class="col-md-12 form-label"> @lang('site.image') </label>
                                        <div class="col-md-12">
