...
<footer class="login-footer text-center">
    <div class="d-sm-block">
        <i class="fa fa-mobile-alt"></i> <span class="text-sm text-muted px-2"> {{__('site.Download App Now')}} </span>
    </div>
    <div class="appIcons my-2">
        <a href="{{ $data['settings']->android_link }}"><img src="{{ asset('site_assets/'.$dir.'/images/googleplay.png') }}" /></a>
        <a href="{{ $data['settings']->ios_link }}"><img src="{{ asset('site_assets/'.$dir.'/images/appstore.png') }}" /></a>
    </div>
...
{{--                                                    src="{{ asset('site_assets/'.$dir.'/images/VAT.png') }}"/> </a>--}}
{{--    </li>--}}
