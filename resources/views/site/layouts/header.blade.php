 ...
 <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
  ...
  <div class="collapse navbar-collapse order-3" id="navbarCollapse">
    ...
    <form class="form-inline ml-0 ml-md-3" method="get" action="{{ route('search') }}" >
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" name='search' type="search" placeholder="@lang('site.Search')" aria-label="Search">
  ...
  <ul class="list-group order-1 order-md-3 navbar-nav navbar-no-expand ml-auto right-nav">
    ...
    <li class="nav-item dropdown header-profile">
      ...
      <div class="image">
        <img src="{{ Storage::url('users/'.Auth::user()->image) }}" class="img-circle elevation-1 img-size-40" alt="User Image">
      </div>
    </a>
    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow p-0">
      <li>
        <a href="{{ route('profile.index') }}" class="user-panel d-flex p-2 bg-gray-light">
          <div class="image p-0">
            <img class="img-circle elevation-1" alt="User Image" src="{{ Storage::url('users/'.Auth::user()->image) }}">
          </div>
          <div class="info">
