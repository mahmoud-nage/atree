...
@section('styles')
    <style>
        ...
        #image_front_src, #image_back_src {
            visibility:hidden;
            width:0;
            height:0
        }
                                    ...
                                    <div class="col-9 product-image-container"
                                        ...
                                        <div class="row">
                                            <div class="flip-shirt col-3"
                                                ...
                                                <label for="image_front_src" id="label_image_front_src"  style="margin-bottom: 0 !important;cursor: pointer;">
                                                    <i class="fa fa-file-upload" style="pointer-events: none"></i>
                                                </label>
                                                <input type="file" class="filestyle" name="image_front_src"
                                                       id="image_front_src"/>
                                                <label for="image_back_src" id="label_image_back_src"  style="margin-bottom: 0 !important;cursor: pointer;" class="d-none">
                                                    <i class="fa fa-file-upload" style="pointer-events: none"></i>
                                                </label>
        ...
        $(document).ready(function () {
            ...
            $("#flip-shirt").click(function () {
                ...
                if ($('.product-image').attr('src') == rotateImgfront) {
                    ...
                    $('#label_image_front_src').addClass('d-none');
                    $('#image_front_src').addClass('d-none');
                    $('#image_back_src').removeClass('d-none');
                    $('#label_image_back_src').removeClass('d-none');
                    ...
                    $('#label_image_back_src').addClass('d-none');
                    $('#image_front_src').removeClass('d-none');
                    $('#label_image_front_src').removeClass('d-none');
