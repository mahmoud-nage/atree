...
<span class="breadcrumb-item active"> تعديل بيانات المسوق </span>
@endsection
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header bg-primary text-white header-elements-sm-inline" >
				<h5 class="card-title"> تعديل بيانات المسوق </h5>
			...
			<form action="{{ route('dashboard.marketers.update' , ['marketer' => $marketer->id ] ) }}" method='POST' enctype="multipart/form-data" > 
				@csrf
				@method('PATCH')
				<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-md-4">
								<div  class='mb-2' >
									...
									<input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $marketer->name }}" >
									@error('name')
									<p  class='text-danger' >  {{ $message }} </p>
									@enderror
								</div>
							...
							<div class="col-md-4">
								<div  class='mb-2' >
									...
									<input type="email" name='email' value="{{ $marketer->email }}" class="form-control @error('email') is-invalid @enderror" >
									@error('email')
									<p  class='text-danger' >  {{ $message }} </p>
									@enderror
								</div>
							...
							<div class="col-md-4">
								<div  class='mb-2' >
									...
									<input type="text" name='phone' value="{{ $marketer->phone }}" class="form-control @error('phone') is-invalid @enderror" >
									@error('phone')
									<p  class='text-danger' >  {{ $message }} </p>
									@enderror
								</div>
...
{{-- 
							...
							<div class="col-md-12">
								<div  class='mb-2' >
									...
									<img class='img-thumbnail img-responsive' src="{{ Storage::url('users/'.$marketer->image) }}" alt="">
								</div>
							</div>
				...
				<div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center py-sm-2">
					<a href="{{ route('dashboard.marketers.index') }}" class="btn btn-outline-primary w-100 w-sm-auto"> @lang('dashboard.cancel') </a>
