...
@section('page_header')
    <a href="{{ route('dashboard.categories.index') }}" class="breadcrumb-item"><i
            class="icon-equalizer   mr-2"></i> @lang('categories.categories')</a>
            ...
            <div class="card">
                ...
                <form action="{{ route('dashboard.categories.update' , ['category' => $category->id ] ) }}"
                    ...
                    <div class="card-body">
                        ...
                        <fieldset class="mb-3">
                            <legend
                                class="text-uppercase font-size-sm font-weight-bold">@lang('categories.category_details')</legend>
                                ...
                                <div class="col-md-6">
                                    <div class='mb-2'>
                                        ...
                                        <input type="text" class="form-control @error('name.ar') is-invalid @enderror"
                                               name="name[ar]" value="{{ $category->getTranslation('name' , 'ar') }}">
                                        @error('name.ar')
                                        <p class='text-danger'>  {{ $message }} </p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class='mb-2'>
                                        ...
                                        <div class="custom-control custom-switch mb-2">
                                            <input type="checkbox" name="show_in_home_page" class="custom-control-input"
                                                   id='show_in_home_page' {{ $category->show_in_home_page == 1 ? 'checked' : '' }} >
                                    ...
                                    <div class='mb-2'>
                                        ...
                                        <div class="custom-control custom-switch mb-2">
                                            <input type="checkbox" name="active" class="custom-control-input"
                                                   id='active' {{ $category->active == 1 ? 'checked' : '' }} >
                                            <label class="custom-control-label"
                                ...
                                <div class="col-md-12">
                                    <div class='mb-2'>
                                        ...
                                        <img class='img-thumbnail img-responsive'
                                             src="{{ Storage::url('categories/'.$category->image) }}" alt="">
                                    </div>
                                </div>
                    ...
                    <div
                        class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center py-sm-2">
                        <a href="{{ route('dashboard.categories.index') }}"
                           class="btn btn-outline-primary w-100 w-sm-auto"> @lang('dashboard.cancel') </a>
                        <button type="submit"
                                class="btn btn-primary mt-3 mt-sm-0 w-100 w-sm-auto"> @lang('dashboard.edit') </button>
				</div>
			</form>
		</div>
	</div>
