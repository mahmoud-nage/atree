...
@section('page_header')
    <a href="{{ route('dashboard.pages.index') }}" class="breadcrumb-item"><i
            class="icon-newspaper2 mr-2"></i> @lang('pages.pages')</a>
            ...
            <div class="card">
                ...
                <form action="{{ route('dashboard.pages.store') }}" method='POST' enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <fieldset class="mb-3">
                            <legend
                                class="text-uppercase font-size-sm font-weight-bold">@lang('pages.page_details')</legend>
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <div class='mb-2'>
                                        ...
                                        <input type="text" class="form-control @error('title.ar') is-invalid @enderror"
                                               name="title[ar]" value="{{ old('title.ar') }}" required>
                                        @error('title.ar')
                                ...
                                <div class="col-md-12">
                                    <div class='mb-2'>
                                        ...
                                        <textarea name="content[ar]" id="tiny"
                                                  class="form-control @error('content.ar') is-invalid @enderror"
                                                  rows="3" required>{{ old('content.ar') }}</textarea>
                                        @error('content.ar')
                                        <p class='text-danger'>  {{ $message }} </p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class='mb-2'>
                                        ...
                                        <textarea name="content[en]" id="tiny"
                                                  class="form-control @error('content.en') is-invalid @enderror"
                                                  rows="3" required>{{ old('content.en') }}</textarea>
                                        @error('content.en')
                                        <p class='text-danger'>  {{ $message }} </p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class='mb-2'>
                                        <label class="col-form-label"> @lang('pages.slug') </label>
                    ...
                    <div
                        ...
                        <button type="submit"
                                class="btn btn-primary mt-3 mt-sm-0 w-100 w-sm-auto"> @lang('dashboard.add') </button>
                    </div>
                </form>
            </div>
        </div>
