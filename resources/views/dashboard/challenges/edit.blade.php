						...
						<div class="form-group row">
							...
							<div class="col-md-4">
								<div  class='mb-2' >
									...
									<input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $challenge->title }}" >
									@error('title')
							...
							<div class="col-md-4">
								<div  class='mb-2' >
									...
									<input type="text" class="form-control @error('orders') is-invalid @enderror" name="orders" value="{{ $challenge->orders }}" >
									@error('orders')
									<p  class='text-danger' >  {{ $message }} </p>
									@enderror
								</div>
							...
							<div class="col-md-4">
								<div  class='mb-2' >
									...
									<input type="color" class="form-control @error('color') is-invalid @enderror" name="color" value="{{ $challenge->color }}" >
									@error('color')
									<p  class='text-danger' >  {{ $message }} </p>
									@enderror
								</div>
							...
							<div class="col-md-4">
								<div  class='mb-2' >
									...
									<input type="date" class="form-control @error('starts_at') is-invalid @enderror" name="starts_at" value="{{ $challenge->starts_at }}" >
									@error('starts_at')
									<p  class='text-danger' >  {{ $message }} </p>
									@enderror
								</div>
							...
							<div class="col-md-4">
								<div  class='mb-2' >
									...
									<input type="date" class="form-control @error('ends_at') is-invalid @enderror" name="ends_at" value="{{ $challenge->ends_at }}" >
									@error('ends_at')
									<p  class='text-danger' >  {{ $message }} </p>
									@enderror
								</div>
							...
							<div class="col-md-12">
								<div  class='mb-2' >
									...
									<div class="custom-control custom-switch mb-2">
										<input type="checkbox" class="custom-control-input" name='should_user_finishes_to_receive_money' id="sc_ls_c" {{ $challenge->should_user_finishes_to_receive_money == 1 ? 'checked' : '' }} >
							...
							<div class="col-md-12">
								<div  class='mb-2' >
									...
									<div class="custom-control custom-switch mb-2">
										<input type="checkbox" class="custom-control-input" name='is_active' id="sc_ls_c1" {{ $challenge->is_active == 1 ? 'checked' : '' }} >
