	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header bg-primary text-white header-elements-sm-inline" >
				<h5 class="card-title"> إضافه كوبون خصم </h5>
						...
						<div class="form-group row">
							...
							<div class="col-md-4">
								<div  class='mb-2' >
									...
									<input type="number" class="form-control @error('allow_times') is-invalid @enderror" name="allow_times" value="{{ old('allow_times') }}" >
									@error('allow_times')
									<p  class='text-danger' >  {{ $message }} </p>
									@enderror
								</div>
							...
							<div class="col-md-12">
								<div  class='mb-2' >
									...
									<div class="custom-control custom-switch mb-2">
										<input type="checkbox" class="custom-control-input" name='allowed_more_than_once_per_user' id="sc_ls_c" checked>
							...
							<div class="col-md-12">
								<div  class='mb-2' >
									...
									<div class="custom-control custom-switch mb-2">
										<input type="checkbox" class="custom-control-input" name='active' id="sc_ls_c1" checked>
