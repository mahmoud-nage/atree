...
@section('page_title')
{{ trans('admins.edit_admin_details') }}
@endsection
				...
				<div class="card-body">
					...
					<fieldset class="mb-3">
						...
						<div class="form-group row">
							...
							<div class="col-md-4">
								<div  class='mb-2' >
									<label class="col-form-label"> @lang('admins.current_image') </label>
									<img class='img-thumbnail img-responsive' src="{{ Storage::url('admins/'.$admin->image) }}" alt="">
								</div>
							</div>
